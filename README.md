...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/git-filter-repo-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11575&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/git-filter-repo-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `git-filter-repo` can be installed with:

```
conda install git-filter-repo
```

It is possible to list all of the versions of `git-filter-repo` available on your platform with:
